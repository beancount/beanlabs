...
from beanlabs.plugins import fill_account
...
class TestFillAccountOpen(cmptest.TestCase):
    ...
    def test_fill_account_invalid_account(self, entries, errors, _):
        """
        plugin "beanlabs.plugins.fill_account" "Assets:Not_An_Account_Name"
    ...
    def test_fill_account(self, entries, _, options_map):
        """
        plugin "beanlabs.plugins.fill_account" "Assets:Cash"
